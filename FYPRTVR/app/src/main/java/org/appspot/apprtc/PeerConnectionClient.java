...
public class PeerConnectionClient {
  ...
  private VideoRenderer.Callbacks remoteRender_left;
  private VideoRenderer.Callbacks remoteRender_right;
  ...
  public void createPeerConnection(
      ...
      final VideoRenderer.Callbacks remoteRender_left,
      final VideoRenderer.Callbacks remoteRender_right,
    ...
    this.remoteRender_left = remoteRender_left;
    this.remoteRender_right = remoteRender_right;
  ...
  private void createCapturer(CameraEnumerator enumerator) {
    ...
    //todo isFucFacing to isBackFacing
      ...
      executor.execute(new Runnable() {
        ...
        public void run() {
          ...
          if (stream.videoTracks.size() == 1) {
            ...
            remoteVideoTrack.setEnabled(renderVideo);
            if(!isSender) {
              remoteVideoTrack.addRenderer(new VideoRenderer(remoteRender_left));
              remoteVideoTrack.addRenderer(new VideoRenderer(remoteRender_right));
            }
          }
        }
      });
