...
/**
 * Created by ngnicola on 4/5/2017.
 */

public class DeleteTravelActivity extends AsyncTask<String,Void,String[]> {
    ...
    public DeleteTravelActivity(Context context,Activity activity) {
