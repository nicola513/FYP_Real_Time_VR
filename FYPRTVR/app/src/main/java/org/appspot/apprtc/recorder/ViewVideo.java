package org.appspot.apprtc.recorder;
...
import org.appspot.apprtc.youtube.YoutubeMain;
...
public class ViewVideo extends Activity {
    private static final String TAG = ViewVideo.class.getSimpleName();
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)+"/eTourismVideo";
        ...
        listAdapter = new ArrayAdapter(this,android.R.layout.simple_list_item_1,mylist);
        videoList.setAdapter(listAdapter);
        //videoList.setBackgroundColor(000000);

        videoList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                videoName =  videoList.getItemAtPosition(position).toString();

                handleIntent(getIntent());

                Toast.makeText(getApplicationContext(), "The selected video:" + videoName, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private class ActivityEventListener extends VrVideoEventListener  {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    ViewVideo.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
    ...
    class VideoLoaderTask extends AsyncTask<Pair<Uri, Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, Options>... fileInformation) {
            try {
                ...
                Uri uri = Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES)+"/eTourismVideo/"+videoName);
                // Uri uri = roomUri.toString();
                ...
                if (fileInformation == null || fileInformation.length < 1
                    ...
                    if(videoName==null){
                        videoWidgetView.loadVideoFromAsset("default.mp4", options);
                    }else
                ...
                videoWidgetView.post(new Runnable() {
                    ...
                    public void run() {
                        Toast
                                .makeText(ViewVideo.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
    ...
    private Button.OnClickListener listener = new Button.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                ...
                case R.id.youtube:
                    //Intent intent = new Intent();
                    intent.setClass(ViewVideo.this, YoutubeMain.class);
