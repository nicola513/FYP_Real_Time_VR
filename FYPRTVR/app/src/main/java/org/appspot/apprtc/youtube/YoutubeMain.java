...
import org.appspot.apprtc.util.NetworkSingleton;
import org.appspot.apprtc.util.Upload;
import org.appspot.apprtc.util.Utils;
import org.appspot.apprtc.util.VideoData;
 ...
 */
public class YoutubeMain extends Activity implements
        ...
        new AsyncTask<Void, Void, List<VideoData>>() {
            ...
            protected List<VideoData> doInBackground(Void... voids) {
                ...
                try {
                    ...
                    Utils.logAndShow(YoutubeMain.this, Constants.APP_NAME, e);
                }
                return null;
            }
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(
                        connectionStatusCode, YoutubeMain.this,
