...
/**
 * Created by ngnicola on 1/3/2017.
 */
...
public class ReceiverActivity extends Activity
    ...
    private SurfaceViewRenderer remoteRender_left;
    private SurfaceViewRenderer remoteRender_right;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Create UI controls.
        //TODO localRender and remoteRender
        remoteRender_left = (SurfaceViewRenderer) findViewById(R.id.remote_video_view_left);
        remoteRender_right = (SurfaceViewRenderer)findViewById(R.id.remote_video_view_right);
        ...
        //TODO try delete onClickListener
        remoteRender_left.setOnClickListener(listener);
        remoteRender_right.setOnClickListener(listener);

        // Create video renderers.
        rootEglBase = EglBase.create();
        remoteRender_left.init(rootEglBase.getEglBaseContext(), null);
        remoteRender_right.init(rootEglBase.getEglBaseContext(), null);
        updateVideoView();
        ...
        peerConnectionClient.createPeerConnectionFactory(
                ReceiverActivity.this, peerConnectionParameters, ReceiverActivity.this);
    ...
    private void updateVideoView() {
        ...
        //remoteRender_left.setScalingType(scalingType);
        remoteRender_left.setMirror(false);
        //remoteRender_left.setLayoutParams(new ViewGroup.LayoutParams(hight,width));
        remoteRender_left.requestLayout();
        //remoteRender_right.setScalingType(scalingType);
        remoteRender_right.setMirror(false);
        //remoteRender_right.setLayoutParams(new FrameLayout.LayoutParams(hight,width));
        remoteRender_right.requestLayout();
    ...
    private void disconnect() {
        ...
        if (remoteRender_right != null) {
            remoteRender_right.release();
            remoteRender_right = null;
        }
        if (remoteRender_left != null) {
            remoteRender_left.release();
            remoteRender_left = null;
        }
    ...
    private void onConnectedToRoomInternal(final AppRTCClient.SignalingParameters params) {
        ...
        peerConnectionClient.createPeerConnection(rootEglBase.getEglBaseContext(),
                null, remoteRender_left,remoteRender_right, signalingParameters,false);
