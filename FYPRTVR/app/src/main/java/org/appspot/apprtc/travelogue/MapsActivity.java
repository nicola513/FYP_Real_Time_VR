...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,OnConnectionFailedListener,
        ConnectionCallbacks,GoogleMap.OnPoiClickListener {
    ...
    public LatLng myPlace = null;
    public Marker mPlace;

    //public TextView name_text,type_text,rating_text;
    public boolean changePosition = false;
    public Button  clear , search, enter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.name_to_locaton_page);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!address.getText().toString().matches("")) {
                    ...
                    try {
                        addressLocation = geoCoder.getFromLocationName(address_text, 1);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    if (addressLocation != null) {
                        ...
                        if (!changePosition) {
                            mPlace = mMap.addMarker(new MarkerOptions().position(myPlace)
                                    .title("Your address"));

                            changePosition = true;
                        } else {
                            mPlace.setPosition(myPlace);
                        }
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String position = "("+latitudeText+" , "+longitudeText+")";
    ...
    public void onPoiClick(PointOfInterest poi) {
        ...
        Places.GeoDataApi.getPlaceById(mGoogleApiClient, poi.placeId)
                .setResultCallback(new ResultCallback<PlaceBuffer>() {
                    @Override
                    public void onResult(PlaceBuffer places) {
                        if (places.getStatus().isSuccess() && places.getCount() > 0) {
                            final Place clickplace = places.get(0);
                            Toast.makeText(getApplicationContext(),
                                    "Name: " + clickplace.getName() +
                                            "\nPlace type:" + clickplace.getPlaceTypes().get(0).toString() +
                                            "\nRating:" + clickplace.getRating(),
                                    Toast.LENGTH_SHORT).show();
                        } else {
    ...
    private void getDeviceLocation() {
        ...
        if (mCameraPosition != null) {
            ...
            myPlace = new LatLng(mCameraPosition.target.latitude, mCameraPosition.target.longitude);
        ...
        if (myPlace != null) {
            ...
            Double dLat = myPlace.latitude;
            Double dLong = myPlace.longitude;
        } else {
            Log.d(TAG, "Current location is null. Using defaults.");
        }
